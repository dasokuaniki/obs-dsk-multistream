...
PlatformPresetRegistry::PlatformPresetRegistry()
	: presets_({
		  ...
		  {"tiktok", "TikTok", "rtmp://push.tiktokcdn.com/live", "https://www.tiktok.com/live", "dsk-vertical", 6000, 4500,
		   "TikTok is usually best paired with the DSK Vertical output.", true},
